<template>
    ...
    <div class="container">
      ...
      <div class="about-content">
        <div class="about-text" data-aos="fade-right">
          <p>Мы — команда корпорации развлечений Чеширский код, родились и живём в Красноярске, и с 2015 года создаём
            проекты, которые дарят эмоции, впечатления и радость всей семье. Компания официально образовалась в 2017
            году, и всё началось с квестов в реальности.</p>
          <p>Мы уделяем внимание каждой детали, поэтому наши квесты до сих пор остаются одними из самых любимых
            развлечений гостей всех возрастов. У нас есть форматы как с актёрами, так и классические сценарные квесты, а
  ...
  <section class="organizations">
    <div class="container">
      ...
      <p class="section-intro" data-aos="fade-up" data-aos-delay="100">Со временем мы поняли, что хотим большего — так
        родились новые уникальные форматы:</p>
  ...
  <section class="mission">
    <div class="container">
      <div class="mission-content" data-aos="zoom-in">
        ...
        <p>Мы развиваемся и расширяемся, но остаёмся верны своей идее делать лучшее, что только можно придумать для
          веселья, эмоций и настоящих приключений</p>
      </div>
    </div>
  </section>

  <section class="contacts">
    <h2 data-aos="fade-up">Карта наших филиалов</h2>
    <Map></Map>
  </section>
